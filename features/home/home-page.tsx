...
const faqItems = [
  {
    answer: "Это счёт в Локерсах (LK). Его можно пополнить картой или через СБП, а покупки списываются с баланса.",
    question: "Что такое внутренний баланс?",
  },
  {
    answer: "После оплаты Locker обрабатывает заказ. Если выдача автоматическая, товар приходит после проверки заказа.",
